...
pub fn list_methods() {
    let methods: &[(&str, &str)] = &[
        ...
        ("setChatMenuButton", "Set the bot's menu button in a private chat"),
        ("getChatMenuButton", "Get the bot's menu button"),
        ("setMyDefaultAdministratorRights", "Set default admin rights for the bot"),
        ("getMyDefaultAdministratorRights", "Get default admin rights of the bot"),
        // Updates
        ...
        ("copyMessage", "Copy a message without 'Forwarded from' header"),
        ("copyMessages", "Copy multiple messages at once"),
        ("sendChatAction", "Send a chat action (typing, uploading, etc.)"),
        ...
        ("setChatAdministratorCustomTitle", "Set a custom title for an admin"),
        ...
        ("createChatSubscriptionInviteLink", "Create a subscription invite link"),
        ("editChatSubscriptionInviteLink", "Edit a subscription invite link"),
        ...
        // Forum topics
        ("getForumTopicIconStickers", "Get custom emoji stickers for forum topic icons"),
        ...
        ("unpinAllForumTopicMessages", "Clear pinned messages in a topic"),
        ("editGeneralForumTopic", "Edit the 'General' forum topic"),
        ("closeGeneralForumTopic", "Close the 'General' forum topic"),
        ("reopenGeneralForumTopic", "Reopen the 'General' forum topic"),
        ("hideGeneralForumTopic", "Hide the 'General' forum topic"),
        ("unhideGeneralForumTopic", "Unhide the 'General' forum topic"),
        ("unpinAllGeneralForumTopicMessages", "Clear pinned messages in 'General'"),
        // Stickers
        ...
        ("setStickerSetThumbnail", "Set the thumbnail of a sticker set"),
        ("setCustomEmojiStickerSetThumbnail", "Set custom emoji sticker set thumbnail"),
        ...
        ("setStickerMaskPosition", "Set the mask position of a sticker"),
        // Inline
        ("answerCallbackQuery", "Answer a callback query from inline keyboard"),
        ...
        ("editUserStarSubscription", "Edit a user's Star subscription"),
        // Games
        ("sendGame", "Send a game"),
        ("setGameScore", "Set the score of a user in a game"),
        ("getGameHighScores", "Get high score table for a game"),
        // Other
        ("setPassportDataErrors", "Inform Telegram Passport about data errors"),
        ...
        ("getBusinessConnection", "Get info about a business connection"),
        ("getAvailableGifts", "Get the list of gifts available for sending"),
...
pub async fn call_method(token: &str, method: &str, params_json: Option<&str>) -> anyhow::Result<()> {
